...
*significance testing code (run significance test), confounders: what could be affecting the voting age population, how much involvement is your community with civic engagement, education level, income status*

## Conclusion

### Next Steps

*what could other people be researching more in this direction, treating racial groups as monolith, want to consider other ethnic groups, observations are being sorted into their racial category*