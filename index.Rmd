...
The previous section looked a range of state CVAP estimates and displays how the outcome varies among the main explanatory variable. The following section displays plot summaries and multiple regression results for both Latinos and Asians.
